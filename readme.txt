...
1. Separate Login Form with captcha running on Twenty Twenty theme.
2. Separate Login Form without captcha running on Twenty Twenty theme.
...
= 2.0.0 =
* Fixed a redirection loop bug.
* Optimized code for increased performance.
* Fixed where plugin styles may override your theme's UI.
